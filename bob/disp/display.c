 ...
 *  $Id: Form1.h,v 1.45 2014/02/11 08:28:12 tony Exp $
 *  $Author: tony $
 *  $Revision: 1.45 $
 *
...
const unsigned char GammaData[]={
	,
	...
	0xD7,0xD8,0xD9,0xDA,0xDB,0xDC,0xDD,0xDE,0xDF,0xE0,0xE1,0xE2,0xE2,0xE3,0xE4,0xE5,
	0xE6,0xE7,0xE7,0xE8,0xE9,0xEA,0xEB,0xEB,0xEC,0xED,0xED,0xEE,0xEF,0xEF,0xF0,0xF1,
	0xF1,0xF2,0xF3,0xF3,0xF4,0xF4,0xF5,0xF6,0xF6,0xF7,0xF7,0xF8,0xF8,0xF9,0xF9,0xF9,
	0xFA,0xFA,0xFB,0xFB,0xFC,0xFC,0xFC,0xFD,0xFD,0xFD,0xFE,0xFE,0xFE,0xFE,0xFF,0xFF,
...
int display_set_play_full(int format)
{
   switch (format) {
    ...
    case VIDEO_STD_PAL: 
    	...
    	/* set pre-play reg */
        writel(0x03000E55, PPLAY_LB_CONF_REG);/*bob*/
        writel(0x00101230, PPLAY_TIMING_REG);/*bob*/
        writel(0x11, 0xB0400E20);
        writel(0x00, 0xB0400E20);
        break;
    default:
