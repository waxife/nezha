 ...
 *  $Id: i80_ctrl_setting.c,v 1.3 2015/08/20 08:05:38 kevin Exp $
 *  $Author: kevin $
 *  $Revision: 1.3 $
 *
...
int i80_T582_ili9327_setting(int width, int height){
    ...
    pi80->lcm->fac = 2;         // (I80_R04)Full bus, Address Cycle count 
    ...
    WRITEL (0x020D030D, I80_R03);   // Read/Write Strobe. In T582 you should not modify it!
...
int i80_T582_ili9341_setting(int width, int height)
{
    /* setup private data */
    memset (pi80, 0, sizeof (struct i80c));
    pi80->lcm = &lcm_ctr;
